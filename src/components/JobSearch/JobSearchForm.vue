<template>
  <form class="flex h-12 w-full items-center rounded-3xl border border-solid border-brand-gray-3">
    ...
    <div class="flex h-full flex-1 flex-nowrap text-base font-light">
      <div class="fley relative h-full flex-1 items-center pr-3">
        <label class="absolute -top-10 left-0">Role</label>
        <input
          v-model="role"
          type="text"
          placeholder="Software engineer"
          class="mt-2 w-full text-lg font-normal focus:outline-none"
        />
      </div>
      <span
      ...
      <div class="fley relative h-full flex-1 items-center pl-3">

  ...
  <li class="mb-7">
    ...
    >
      <div class="mx-8 border-b border-solid border-brand-gray-2 pb-2 pt-5">
        <h2 class="mb-2 text-2xl">Techical Program Manager, Perception, Augmented reality</h2>
        <div class="flex flex-row align-middle">
          <div class="mr-5">
            <span>RokCareers</span>
          </div>
        ...
        <div>
          ...
          <div>
            <ul class="list-disc pl-8">
              ...
              <li>
                Experience analyzing data throught querying database(e.g., SQL) using spreadsheet
